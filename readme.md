...
* `concurrency` caps the number of simultaneous transfers, with a default of 30 and `0` meaning unlimited. In v1 it throttled new transfers per second, defaulting to 100.
